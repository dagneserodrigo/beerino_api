...
beerinoRepository.prototype.get = function(beerinoId, callback) {
    this._connection.query('SELECT beerinoId, name, description, userId, currentBeerId, currentTaskId, currentTemperature FROM beerino WHERE beerinoId = ?', beerinoId, callback);
}
...
beerinoRepository.prototype.list = function(userId, callback) {
    ...
    this._connection.query('SELECT beerinoId, name, description, userId, currentBeerId, currentTaskId, currentTemperature FROM beerino WHERE userId = ?', userId, callback);
}
